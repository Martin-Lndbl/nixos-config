...
setKV ./trilium-server.nix version $version
...
setKV ./trilium-server.nix x86_64-linux.hash $sha256_linux64
setKV ./trilium-server.nix aarch64-linux.hash $sha256_linux64_arm
setKV ./trilium-server.nix x86_64-darwin.hash $sha256_darwin64
setKV ./trilium-server.nix aarch64-darwin.hash $sha256_darwin64_arm
...
setKV ./trilium-server.nix version $version
setKV ./trilium-server.nix serverSource_x64.hash $sha256_linux64_server
setKV ./trilium-server.nix serverSource_arm64.hash $sha256_linux64_server_arm
